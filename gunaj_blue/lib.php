...
function theme_gunaj_blue_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        $theme = theme_config::load('gunaj_blue');
		if ($filearea === 'logo') {
...
function theme_gunaj_blue_page_init(moodle_page $page) {
