...
function theme_gunaj_gray_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        $theme = theme_config::load('gunaj_gray');
		if ($filearea === 'logo') {
...
function theme_gunaj_gray_page_init(moodle_page $page) {
