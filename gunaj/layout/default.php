...
<nav role="navigation" class="navbar <?php echo $navbartype; ?>">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="http://www.unaj.edu.ar"><?php echo $logo; ?></a>
    </div>
...
<section id="main" class="clearfix default">
    <div id="page" class="<?php echo $container; ?>">
		...
		<div class="course_title">
			<span class="course_title_left"></span>
			<span class="course_title_right"></span>
			<?php $title=  explode("|",$PAGE->course->fullname)[0] ?>
			<?php $subtitle=  explode("|",$PAGE->course->fullname)[1] ?>
			<div class="course_title_center">
