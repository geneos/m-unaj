var app = angular.module('siuMoodleApp', ['ngTable','angular-md5','LocalStorageModule','DigestAuthInterceptor'],function($httpProvider) {
	...
	*/ 
	...
	for (var i = 0; i<cursosMoodle.length ; i++){
		if (comision == cursosMoodle[i].shortname)
			return true;
	}
	return false;
	};
