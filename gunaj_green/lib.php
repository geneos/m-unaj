...
function theme_gunaj_green_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
    if ($context->contextlevel == CONTEXT_SYSTEM) {
        $theme = theme_config::load('gunaj_green');
		if ($filearea === 'logo') {
...
function theme_gunaj_green_page_init(moodle_page $page) {
